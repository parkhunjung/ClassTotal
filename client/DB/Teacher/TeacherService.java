...
//----------------------------------------------------------------------
	...
	public void teacherConsult() throws InterruptedException {
	      ...
	      case "1": // 상담 요청 조회
	         flag = 1;
	         System.out.println("\t\t\t[ 상담 요청 조회 ] 로 이동합니다 . . .");
	         view.pause();
	         break;

	      case "2": // 상담 내역 확인
	         flag = 2;
	         System.out.println("\t\t\t[ 상담 내역 확인 ] 으로 이동합니다 . . .");
	         view.pause();
	         break;

	      case "3": // 상담 일지 입력
	         flag = 3;
	         System.out.println("\t\t\t[ 상담 일지 입력 ] 으로 이동합니다 . . .");
	         view.pause();
	         break;
	      ...
	      if (flag == 1) { // 상담 요청 조회
	         ...
	         System.out.println("\t\t\t상담하실 상담번호를 입력해 주세요\n");
	         System.out.println();
	         System.out.println();
	         System.out.print("\t\t\t상담 번호 입력 : ");
	         consultNum = scan.nextLine();
	         System.out.println("\n\n\n\n\n\n\n");
	         System.out.println();
	         System.out.println("\t\t\t작성하실 상담내용을 입력해 주세요\n\n");
	         System.out.println("\t\t\t――――――――――――――――――――――――――");
