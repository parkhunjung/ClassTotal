...
public class View_AdminFunction_A {
	...
	public void vOpenMgmtSubjectRegistration(ArrayList<DTO_Subject> list) {
		...
		for(int i = 0; i < list.size(); i++) {
			System.out.println("\t\t\t\t" + list.get(i).getSubject_seq()+".\t\t" + list.get(i).getName() + "\t\t\t" + list.get(i).getPeriod());
		}
	...
	public void vCourse(ArrayList<DTO_Course> list) {
		...
		for(int i = 0; i < list.size(); i++) {
			System.out.println("\t\t\t\t\t" + list.get(i).getCourse_seq() + ".\t" + list.get(i).getName() + "\t\t\t" + list.get(i).getPeriod());
		}
	...
	public void vTeacherEvalQuestionResultInfoDelete(ArrayList<DTO_t_tc_oc_c_A> list) {
		...
		for(int i = 0; i < list.size(); i++) {
			...
			System.out.println("\t\t\t\t\t\t" + list.get(i).getOpenCourse_seq() + ".\t" + list.get(i).getCourseName() + "\t\t" + list.get(i).getTeacherName());
	...
	public void vTeacherEvalQuestionResultInfoDeleteInfo(String courseName, String teacherName, ArrayList<DTO_Example> objectiveFormlist, ArrayList<DTO_TeacherEval_Q> objectiveFormResultlist, ArrayList<DTO_TeacherEval_Q> subjectiveEx) {
		...
		for(int i = 0; i < objectiveFormResultlist.size(); i++) {
			System.out.printf("%50s\t%s%% \t%s%%     %s%%   %s%%    %s%%\n"
								, objectiveFormResultlist.get(i).getQuestion()
								, objectiveFormResultlist.get(i).getRatio1()
								, objectiveFormResultlist.get(i).getRatio2()
								, objectiveFormResultlist.get(i).getRatio3()
								,objectiveFormResultlist.get(i).getRatio4()
								,objectiveFormResultlist.get(i).getRatio5()
								);
		}
		System.out.println();
		System.out.println();
