...
public class Service_AdminFunction_A implements IService_AdminFunction_A {
	...
	@Override
	/**
	 * 관리자 > 개설 과정 및 과목 관리 에서 나타낼 정보들을 가져오기위한 메소드
	 */
	...
	@Override
	/**
	 * 관리자 > 개설 과정 및 과목 관리 > 상세보기 기능을 수행할 메소드
	 */
	...
	@Override
	/**
	 * 관리자 > 개설 과정 및 과목 관리 > 상세보기 > 개설 과목 정보 등록 기능을 수행할 메소드
	 */
	...
	@Override
	/**
	 * 관리자 > 상담일지 관리 및 조회 > 상담 일지 내역 > 일괄 조회 > 수정
	 */
	...
	@Override
	/**
	 * 관리자 > 상담일지 관리 및 조회 > 상담 일지 내역 > 학생별 조회 및 수정 > 학과
	 */
	...
	@Override
	/**
	 * 관리자 > 교사 평가 관리 및 결과 조회 > 교사 평가 결과 조회 및 삭제 > 주관식 문제번호 선택
	 * 
	 */
	 ...
	 */
	 ...
	 /**
	  * 콘솔에서 화면을 보여줄 때 다른 기능이 보이지 않도록 하는 메소드
	  */
