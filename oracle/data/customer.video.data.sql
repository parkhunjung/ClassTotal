...
-- 판매 데이터
insert into tblsales (seq, item, qty, customerseq) values (1, '전화기', 1, 1);
insert into tblsales (seq, item, qty, customerseq) values (2, '다이어리', 3, 2);
insert into tblsales (seq, item, qty, customerseq) values (3, '노트', 10, 2);
insert into tblsales (seq, item, qty, customerseq) values (4, '볼펜', 20, 3);
insert into tblsales (seq, item, qty, customerseq) values (5, '지우개', 15, 3);
insert into tblsales (seq, item, qty, customerseq) values (6, '마우스', 5, 1);
insert into tblsales (seq, item, qty, customerseq) values (7, '키보드', 2, 3);
insert into tblsales (seq, item, qty, customerseq) values (8, '모니터', 1, 2);
insert into tblsales (seq, item, qty, customerseq) values (9, '선풍기', 2, 1);
